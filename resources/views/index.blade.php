                ...
                <div class="recently-reviewed-container space-y-12 mt-8">
                    <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                        ...
                        <div class="ml-12">
                            ...
                            <div class="text-gray-400 mt-1">Playstation 4</div>
                            <div class="text-gray-400 mt-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam, debitis dolor doloremque ea harum, itaque laudantium magnam magni maiores minus nesciunt nostrum quae quaerat quo sunt veritatis voluptate. Ex, sapiente.</div>
                        </div>
                    </div>
                    <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                        <div class="relative flex-none">
